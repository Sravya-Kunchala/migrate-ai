...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="M15 6l6 6-6 6"/><path d="M19 12H5"/><path d="M9 18l-6-6 6-6"/></svg>,
        label: "Site Migration",
      },
      {
        icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-4.95"/></svg>,
...
const quickCards = [
  {
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#00C96B" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>,
    title: "5-Minute Setup",
    desc: "Get up and running with basic backups in minutes.",
  },
  {
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#00C96B" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>,
    title: "AI Engine Guide",
    desc: "Configure Smart Migration and anomaly detection.",
  },
  {
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#00C96B" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>,
    title: "Migration Walkthrough",
    desc: "Step-by-step instructions for site relocations.",
  },
  {
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#00C96B" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>,
    title: "API Reference",
    desc: "Full endpoints for custom integrations.",
  },
];
          ...
          >
            ...
            >
              ...
              <AnimatedSection delay={0.05}>
                <div style={{ background: "#161b22", border: "1px solid #21262d", borderRadius: 20, padding: "36px 32px" }}>
                  <h2 style={{ fontSize: 28, fontWeight: 700, color: "#fff", margin: "0 0 16px", letterSpacing: "-0.5px" }}>
                    Introduction
                  </h2>
                  ...
                  <div style={{
                    ...
                    <div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: "#00C96B", letterSpacing: "0.6px", textTransform: "uppercase", marginBottom: 4 }}>
                        v5.0 Update
                      </div>
              ...
              {/* Installation */}
              <AnimatedSection delay={0.05}>
                <h2 style={{ fontSize: 28, fontWeight: 700, color: "#fff", margin: "0 0 24px", letterSpacing: "-0.5px" }}>
                  Installation
                </h2>
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  {[
                    ...
                    <div key={i} className="doc-method-card">
              ...
              <AnimatedSection delay={0.05}>
                <div style={{ background: "#161b22", border: "1px solid #21262d", borderRadius: 20, padding: "36px 32px" }}>
                  <h2 style={{ fontSize: 24, fontWeight: 700, color: "#fff", margin: "0 0 28px", letterSpacing: "-0.3px" }}>
                    Connecting the AI Engine
                  </h2>
                  ...
                  <div style={{
                    ...
                    <div style={{ fontSize: 10, fontWeight: 700, color: "#00C96B", letterSpacing: "1px", textTransform: "uppercase", marginBottom: 6 }}>
                      Cost Information
                    </div>
              ...
              <AnimatedSection delay={0.05}>
                <div style={{ background: "#161b22", border: "1px solid #21262d", borderRadius: 20, padding: "40px 36px", textAlign: "center" }}>
                  <h2 style={{ fontSize: 24, fontWeight: 700, color: "#fff", margin: "0 0 32px", letterSpacing: "-0.3px" }}>
                    Creating Your First Backup
                  </h2>
                  <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                    {[
                      ...
                      <div key={i} style={{
                        ...
                        <span style={{ fontSize: 22, fontWeight: 700, color: "rgba(255,255,255,0.12)", minWidth: 36 }}>
              ...
              <AnimatedSection delay={0.05}>
                ...
                <div className="migration-grid">
                  <div style={{ background: "#161b22", border: "1px solid #21262d", borderRadius: 20, padding: "28px 24px" }}>
                    ...
                    {[
                      "Generate a migration key from the 'Transfer' menu.",
                      "Select specific assets or perform a full sweep.",
                      "Enable 'Ghost Mode' if migrating during peak traffic.",
                    ].map((item, i) => (
                  ...
                  <div style={{ background: "#00C96B", borderRadius: 20, padding: "28px 24px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
                    ...
                    {[
                      "Install a fresh WordPress instance and the MigrateAI plugin.",
                      "Paste the migration key and authorize the secure tunnel.",
                      "Review the AI Conflict Report before final deployment.",
                    ].map((item, i) => (
                      <div key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start", marginBottom: i < 2 ? 14 : 0 }}>
